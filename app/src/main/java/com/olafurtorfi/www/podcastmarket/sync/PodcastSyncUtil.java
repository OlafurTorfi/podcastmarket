...
public class PodcastSyncUtil {
    /*
     * Interval at which to sync with the podcast. Use TimeUnit for convenience, rather than
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        Job syncPodcastJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                /*
                 * We want the podcast data to be synced every 3 to 4 hours. The first argument for
    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        /*
         * We need to check to see if our ContentProvider has data to display in our podcast
        ...
        Thread checkForEmpty = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                /* URI for every row of podcast data in our podcast table*/
                 ...
                 * to determine what podcast details need to be displayed.
                 */
                String[] projectionColumns = {PodcastContract.PodcastEntry._ID};
//                String selectionStatement = PodcastContract.PodcastEntry.getSqlSelectForTodayOnwards();

                /* Here, we perform the query to check to see if we have any podcast data */
